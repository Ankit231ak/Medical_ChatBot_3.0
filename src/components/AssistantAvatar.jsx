    ...
    >
      {videos.map((vid) => (
        <video
          ...
          src={vid.src}
          className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-500 ease-in-out mix-blend-screen scale-[2.1] translate-y-[15%]
 pointer-events-none ${activeState === vid.id ? 'opacity-100 z-0' : 'opacity-0 -z-10'
            }`}
          autoPlay
          muted
          playsInline
